...
(function () {
    ...
    if (typeof layer !== 'undefined') {
        try { layer.config({ anim: 2, shade: [0.3, '#000'] }); } catch (e) { }
    }
    ...
    var ems = {
        msg: function (text, opts, end) {
            if (typeof opts === 'function') { end = opts; opts = {}; }
            opts = Object.assign({ time: 2000 }, opts || {});
            if (end && typeof end === 'function') { opts = Object.assign({}, opts, { end: end }); }
            return L().msg(text, opts);
        },
        ...
        loading: function (text) { return L().load(1, { shade: [0.3, '#000'], content: text }); },
