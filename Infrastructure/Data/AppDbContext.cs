...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder mb)
    {
        ...
        mb.Entity<Project>().HasData(
            new Project
            {
                Id=1001, ProjNo="PRJ-2024-001", ProjName="成都市某片区控制性详细规划",
                DeptId=4, BizType="控制性详细规划", OwnerName="成都市规划和自然资源局",
                OwnerContact="王处长", OwnerPhone="028-12345678",
                ProcurementType="竞争性磋商", ContractAmount=98m,
                IsJointVenture=false, TechLeaderId=108, BizLeaderId=103,
                SignDate=new DateTime(2024,3,15), PlanEndDate=new DateTime(2024,12,31),
                ProgressStatus=6, Remark="重点项目，需配合规委会评审",
                CreatedAt=dt, CreatedBy="system"
            },
            new Project
            {
                Id=1002, ProjNo="PRJ-2024-002", ProjName="某住宅小区结算审核",
                DeptId=2, BizType="结算评审", OwnerName="成都市某国有投资公司",
                OwnerContact="张总", OwnerPhone="13900000001",
                ProcurementType="询价", ContractAmount=45m,
                IsJointVenture=false, TechLeaderId=102, BizLeaderId=101,
                SignDate=new DateTime(2024,5,1), PlanEndDate=new DateTime(2024,8,31),
                ProgressStatus=7, Remark="送审金额约3200万元",
                CreatedAt=dt, CreatedBy="system"
            },
            new Project
            {
                Id=1003, ProjNo="PRJ-2024-003", ProjName="某市政道路工程可行性研究报告",
                DeptId=3, BizType="可行性研究报告", OwnerName="成都市交通运输局",
                OwnerContact="李科长", OwnerPhone="028-87654321",
                ProcurementType="公开招标", ContractAmount=160m,
                IsJointVenture=true, OurRatio=60m, TechLeaderId=103, BizLeaderId=107,
                SignDate=new DateTime(2024,1,20), PlanEndDate=new DateTime(2024,10,31),
                ProgressStatus=6, Remark="联合体项目，牵头方，我方占比60%",
                CreatedAt=dt, CreatedBy="system"
            },
            new Project
            {
                Id=1004, ProjNo="PRJ-2023-018", ProjName="某工业园区概念规划设计",
                DeptId=5, BizType="战略咨询", OwnerName="成都高新区管委会",
                OwnerContact="陈主任", OwnerPhone="13800000099",
                ProcurementType="单一来源", ContractAmount=32m,
                IsJointVenture=false, TechLeaderId=107, BizLeaderId=104,
                SignDate=new DateTime(2023,9,1), PlanEndDate=new DateTime(2024,3,31),
                ActualEndDate=new DateTime(2024,4,15),
                ProgressStatus=8, Remark="已完成，已全额回款",
                CreatedAt=dt, CreatedBy="system"
            },
            new Project
            {
                Id=1005, ProjNo="PRJ-2024-004", ProjName="某新城片区节能评估报告",
                DeptId=2, BizType="节能评估报告", OwnerName="成都天府新区建设局",
                OwnerContact="刘工", OwnerPhone="13700000001",
                ProcurementType="竞争性磋商", ContractAmount=28m,
                IsJointVenture=false, TechLeaderId=105, BizLeaderId=101,
                SignDate=new DateTime(2024,6,10), PlanEndDate=new DateTime(2024,9,30),
                ProgressStatus=3, Remark="投标截止2024-06-10",
                CreatedAt=dt, CreatedBy="system"
            }
        );
        ...
        mb.Entity<BudgetTask>().HasData(
            new BudgetTask
            {
                Id=6001, TaskNo="YS-2024-001", TaskName="某住宅小区（一期）工程结算审核",
                TaskType=5, DeptId=2, OwnerName="成都某房产开发有限公司",
                OwnerContact="赵总", OwnerPhone="13900000002",
                ContractorName="中建三局第二建设工程有限责任公司",
                BuildingScale="住宅12栋，建筑面积约8.6万㎡",
                SubmitAmount=6850m, ApprovedAmount=6312m, ReductionRate=7.85m,
                QuotaBasis="四川省2015建设工程工程量清单计价定额",
                FeeStandard="四川省2015费用定额",
                TechLeaderId=102, BizLeaderId=101,
                PlanDate=new DateTime(2024,8,31), Status=4,
                Remark="核减率7.85%，共出具评审意见42条",
                CreatedAt=dt, CreatedBy="system"
            },
            new BudgetTask
            {
                Id=6002, TaskNo="YS-2024-002", TaskName="某市政道路工程预算编制",
                TaskType=1, DeptId=3, OwnerName="成都市交通运输局",
                OwnerContact="李科长", OwnerPhone="028-87654321",
                ContractorName=null,
                BuildingScale="双向四车道，全长3.2km",
                SubmitAmount=4200m, ApprovedAmount=null, ReductionRate=null,
                QuotaBasis="四川省2020市政工程定额",
                FeeStandard="四川省2020费用定额",
                TechLeaderId=107, BizLeaderId=103,
                PlanDate=new DateTime(2024,10,31), Status=1,
                CreatedAt=dt, CreatedBy="system"
            }
        );
